...
train_dir=/fsx-pretraining/home/siyuanxu/tool_synthetic/RL_training/verl_toolmock/data
...
experiment_name="qwen2_5-7b-toolmock-grpr_rollout8_kl5e-2_${timestamp}"
...
NGPU=4
#export RAY_TMPDIR="/fsx-pretraining/home/siyuanxu/ray_tmp"

export VLLM_USE_V1=1
ray stop --force

echo "📦 Merge and save local cache"
CACHE_FILE="/fsx-pretraining/home/siyuanxu/tool_synthetic/RL_training/cache/tool_cache.json"
S3_DIR="s3://shopqa-users/siyuanxu/tool_mock"
S3_FILE="${S3_DIR}/cache/tool_cache.json"
CHECKPOINT_DIR="/fsx-pretraining/home/siyuanxu/tool_synthetic/RL_training/verl_output/checkpoints/${project_name}/${experiment_name}"
...
python3 -m verl.trainer.main_ppo \
    ...
    reward_model.reward_manager=step_level \
